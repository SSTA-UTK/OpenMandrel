...
int main(int argc, char** argv) {
    ...
    SDL_Window* window = SDL_CreateWindow("OpenMandrel", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
    ...
    while (!done) {
        ...
        // Queueing
        DisplayWindow(io.DisplaySize.x, io.DisplaySize.y);
